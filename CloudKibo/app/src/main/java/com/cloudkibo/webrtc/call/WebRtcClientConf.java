...
public class WebRtcClientConf {
    private final static String TAG = WebRtcClientConf.class.getCanonicalName();
    ...
    public WebRtcClientConf(RtcListener listener, PeerConnectionParameters params, EGLContext mEGLcontext) {
        mListener = listener;
        pcParams = params;
