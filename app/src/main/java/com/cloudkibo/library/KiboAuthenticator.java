...
import static com.cloudkibo.library.AccountGeneral.*;


public class KiboAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "KiboAuthenticator";
    private final Context mContext;

    public KiboAuthenticator(Context context) {
        super(context);
