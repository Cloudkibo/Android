...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_USERCHAT = "userchat";
    ...
    private static final String USERCHAT_ID = "id";
    private static final String USERCHAT_TO = "toperson";
    private static final String USERCHAT_FROM = "fromperson";
    private static final String USERCHAT_FROM_FULLNAME = "fromFullName";
    private static final String USERCHAT_MSG = "msg";
    private static final String USERCHAT_DATE = "date";
    private static final String USERCHAT_UID = "_id";
   ...
   /////////////////////////////////////////////////////////////////////
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_USERCHAT_TABLE = "CREATE TABLE " + TABLE_USERCHAT + "("
                + USERCHAT_ID + " INTEGER PRIMARY KEY, "
                + USERCHAT_TO + " TEXT, "
                + USERCHAT_FROM + " TEXT, "
                + USERCHAT_FROM_FULLNAME + " TEXT, "
                + USERCHAT_MSG + " TEXT, "
                + USERCHAT_UID + " TEXT, "
                + USERCHAT_DATE + " TEXT" + ")";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_USERCHAT);
    ...
    public void addChat(String to, String from, String from_fullname, String msg, String date) {
        ...
        ContentValues values = new ContentValues();
        values.put(USERCHAT_TO, to); // TO
        values.put(USERCHAT_FROM, from); // FROM
        values.put(USERCHAT_FROM_FULLNAME, from_fullname); // FROM FULL NAME
        values.put(USERCHAT_MSG, msg); // CHAT MESSAGE
        values.put(USERCHAT_DATE, date); // DATE

        // Inserting Row
        db.insert(TABLE_USERCHAT, null, values);
        db.close(); // Closing database connection
    }    
    ...
    public JSONArray getChat(String user1, String user2) throws JSONException {
        ...
        String selectQuery = "SELECT  * FROM " + TABLE_USERCHAT + " WHERE ("+
        		USERCHAT_TO +" = '"+ user1 +"' AND "+
        		USERCHAT_FROM +" = '"+ user2 +"') OR ("+
        		USERCHAT_TO +" = '"+ user2 +"' AND "+
        		USERCHAT_FROM +" = '"+ user1 +"')";
        ...
        if(cursor.getCount() > 0){
        	...
        	while (cursor.isAfterLast() != true) {
        		...
        		JSONObject contact = new JSONObject();
        		contact.put(USERCHAT_TO, cursor.getString(1));
        		contact.put(USERCHAT_FROM, cursor.getString(2));
        		contact.put(USERCHAT_FROM_FULLNAME, cursor.getString(3));
        		contact.put(USERCHAT_MSG, cursor.getString(4));
        		contact.put(USERCHAT_UID, cursor.getString(5));
        		contact.put(USERCHAT_DATE, cursor.getString(6));
    ...
    public void resetChatsTable(){
        SQLiteDatabase db = this.getWritableDatabase();
        // Delete All Rows
        db.delete(TABLE_USERCHAT, null, null);
        db.close();
    }
    ...
    public void resetSpecificChat(String user1, String user2){
    	...
    	String deleteQuery = "DELETE FROM " + TABLE_USERCHAT + " WHERE ("+
        		USERCHAT_TO +" = '"+ user1 +"' AND "+
        		USERCHAT_FROM +" = '"+ user2 +"') OR ("+
        		USERCHAT_TO +" = '"+ user2 +"' AND "+
        		USERCHAT_FROM +" = '"+ user1 +"')";
